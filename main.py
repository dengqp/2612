...
def get_weather(region):
    ...
    return weather, temp, max_temp, min_temp, category, pm2p5





def send_message(to_user, access_token, region_name, weather, temp, max_temp, min_temp, category, pm2p5):
...
if __name__ == "__main__":
    ...
    weather, temp, max_temp, min_temp, category, pm2p5 = get_weather(region)
    # 公众号推送消息
    for user in users:
        send_message(user, accessToken, region, weather, temp, max_temp, min_temp, category, pm2p5)
    os.system("pause")
